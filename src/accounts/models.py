...
class MyUserQuerySet(models.query.QuerySet):
    ...
    def paid_member(self):
        return self.filter(is_member=True)
...
class MyUserManager(BaseUserManager):
    ...
    def get_member(self):
        return self.get_queryset().paid_member()
...
def new_user_receiver(sender, instance, created, *args, **kwargs):
    ...
    if created:
        ...
        notify.send(instance,
                    recipient_object=MyUser.objects.get(username='superuser_sbt'), #admin user
